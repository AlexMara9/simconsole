...
import org.simconsole.simconsole.components.DynamicDeck;
...
public class ConsoleController {
	...
	private static final double BUTTON_CONTAINER_SPACING_FACTOR = 0.125;
    ...
    public void setDecks(Deck leftDeck, Deck rightDeck) {
        ...
        javafx.animation.AnimationTimer timer = new javafx.animation.AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                double baseRotationDelta = (elapsedSeconds / 1.8) * 360.0;
